...
<div class="row text-center" style="">
	...
	<button type="button" class="btn btn-primary"  onclick="location.href='../controller/BoardEdit.do?num=<%=dto.getNum()%>';">수정하기</button>
	<button type="button" class="btn btn-success" onclick="location.href='../controller/BoardDelete.do?num=<%=dto.getNum()%>';">삭제하기</button>	
	<button type="button" class="btn btn-warning" 
		onclick="location.href='../space/sub03_list.jsp';">리스트보기</button>
</div>
</form> 
