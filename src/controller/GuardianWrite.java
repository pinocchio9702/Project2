...
@WebServlet("/controller/GuardianWrite.do")
public class GuardianWrite extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(mr !=null) {
			...
			sucOrFail = dao.insertGuardian(dto);
		...
		if(sucOrFail ==1) {
			...
			req.getRequestDispatcher("../community/sub02_write").forward(req, resp);
		}
